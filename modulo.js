...
// Promedio de rating de estas películas

function promedioVotos(){
	var promedio = 0
	var cumplenCondicion = 0

	for (i = 0; i <= 19; i++){     
	 if ( movies[i].vote_average >= 7){ 
		 cumplenCondicion = cumplenCondicion + 1 ;
		 promedio = promedio + movies[i].vote_average;
	     }
      }
	return promedio / cumplenCondicion;
}
...
module.exports = {movies, theaters, faqs, votosMas, promedioVotos};
